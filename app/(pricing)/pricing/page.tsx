        ...
        <div className="flex flex-row justify-evenly items-center mx-auto mt-10">
            ...
            <GlareCard className="flex-col-center">
                <Card className="w-auto h-full bg-transparent border-transparent">
                    ...
                    <CardContent className="text-center">
                        <Button data-testid="select-button-free" variant="outline" onClick={() => {}} className="cursor-move">
                            Select
                        </Button>
                    </CardContent>
                    <CardContent>
            ...
            <GlareCard className="flex-col-center">
                <Card className="w-auto h-full bg-transparent border-transparent">
                    ...
                    <CardContent className="text-center">
                        <Button data-testid="select-button-supporter" variant="outline" onClick={() => {}} className="cursor-move">
                            Select
                        </Button>
                    </CardContent>
                    <CardContent>
